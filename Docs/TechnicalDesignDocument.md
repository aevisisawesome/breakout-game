...
```ts
interface SaveFileV3 {           // current shape; v1 (M1) lacked run.upgrades/run.workers,
  version: 3;                    // v2 (M2) lacked run.ccl + run.unlocks.editor
